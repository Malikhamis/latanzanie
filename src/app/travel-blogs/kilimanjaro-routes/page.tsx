    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[#5BC4AF] to-[#008576] text-white py-20">
        <div className="container mx-auto px-4">
          <Link href="/travel-blogs" className="text-[#E8F8F5] hover:text-white mb-6 inline-flex items-center text-sm font-medium animate-slideInLeft">
            ← Retour aux blogs
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="animate-fadeIn" style={{ animationDelay: '0.1s' }}>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/travel-blogs" className="hover:text-white transition-colors">Blogs de Voyage</Link></li>
                <li><Link href="/about" className="hover:text-white transition-colors">À Propos</Link></li>
                <li><Link href="/see-trips" className="hover:text-white transition-colors">Nos Voyages</Link></li>
