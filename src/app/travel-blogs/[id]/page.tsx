...
export default function BlogDetailPage({ params }: any) {
  ...
  // Runtime will pass a plain object; using params as-is is fine in a client
  // component.
  const category = blogCategories.find(cat => cat.id === parseInt(params?.id)) || blogCategories[0]
