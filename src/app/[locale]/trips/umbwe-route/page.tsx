...
export default function UmbweRoutePage() {
  ...
  const fallbackSampleDates: Record<string, Array<any>> = {
    '2026-Feb': [
      { date: 'Feb 10, 2026', route: '6 Day - Umbwe Route', status: 'Open for bookings', price: 'from €1,900', deposit: 'Deposit €250' }
    ]
  }
  ...
  const [selectedItineraries, setSelectedItineraries] = useState<string[]>(['umbwe'])
  ...
  useEffect(() => {
    ...
    // Default itinerary for this route is 'umbwe'
    setSelectedItineraries((prev) => {
      if (!prev || prev.length === 0) return ['umbwe']
      return prev
    })
  }, [])
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-2 md:order-1">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/umbwecamp.jpg" alt="Day 1" fill className="object-cover" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div key={`day-${d}`} className="mb-12 pb-8 border-b border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      ...
                      <div className={d % 2 === 0 ? 'order-2' : 'order-2 md:order-1'}>
                        <div className="relative w-full h-96 rounded-xl overflow-hidden">
                          <Image src={dayImages[idx]} alt={`Day ${d}`} fill className="object-cover" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    ...
                    <p className="text-gray-500 text-lg md:text-xl leading-relaxed">{t('itinerary.day7.description')}</p>
                  </div>
      ...
      <section ref={datesPricesRef} className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-3 mb-6">
            {selectedItineraries.includes('umbwe') && generateSampleDates(selectedMonths[0] || '2026-Jan', 9).map((dateInfo, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-semibold text-gray-900 text-base">Umbwe Route - 6/7 Days</span>
                    </div>
                    <div className="flex flex-wrap items-center gap-2 text-base text-gray-600">
                      ...
                      <span className="text-sm text-gray-600">Challenging and direct ascent</span>
                      <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-sm font-medium">Available</span>
                    </div>
                  </div>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    <div className="text-right">
                      <div className="text-base text-gray-600">from <span className="font-semibold text-gray-900">€1,900</span></div>
