...
export default function ZanzibarCompleteEscape8DaysPage() {
  ...
  const t = useTranslations('ZanzibarCompleteEscape8Days')
  ...
  const generateSampleDates = (selectedMonth: string) => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      dates.push({
        ...
        dateRange: calculateDateRange(departureDate, 8)
      });
    }
    return dates;
  };
            ...
            <div className="bg-white p-4 md:p-8 rounded-lg shadow-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-2">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/1znz.jpg" alt="Day 1" fill className="object-cover" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-2">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/3znz.jpg" alt="Day 3" fill className="object-cover" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/4znz.jpg" alt="Day 4" fill className="object-cover" />
                    </div>
                  </div>
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">
             ...
             {/* Day 5 */}
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-2">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/5znz.jpg" alt="Day 5" fill className="object-cover" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/6znz.jpg" alt="Day 6" fill className="object-cover" />
                    </div>
                  </div>
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">
              ...
              <div className="mb-12 pb-8 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-1">
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">
                      {t('itinerary.day7.title')}
                    </h3>
                    <p className="text-gray-600 mb-4 text-xl">
                      {t('itinerary.day7.description')}
                    </p>
                  </div>
                  <div className="order-2">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/7znz.jpg" alt="Day 7" fill className="object-cover" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1">
                    <div className="relative w-full h-96 rounded-xl overflow-hidden">
                      <Image src="/images/8znz.jpg" alt="Day 8" fill className="object-cover" />
                    </div>
                  </div>
                  <div className="order-1 md:order-2">
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">
                      {t('itinerary.day8.title')}
                    </h3>
                    <p className="text-gray-600 mb-4 text-xl">
                      {t('itinerary.day8.description')}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {isRouteDropdownOpen && (
                <div className="absolute z-20 mt-2 w-full bg-white rounded-lg shadow-xl border border-gray-200 p-3">
                  <label className="flex items-center gap-2 p-2 rounded hover:bg-gray-50 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={selectedItineraries.includes('zanzibar-complete-escape-8-days')}
                      onChange={() => {
                        if (selectedItineraries.includes('zanzibar-complete-escape-8-days')) {
                          setSelectedItineraries([]);
                        } else {
                          setSelectedItineraries(['zanzibar-complete-escape-8-days']);
                        }
                      }}
                      className="w-4 h-4 text-[#00A896] rounded"
                    />
                    <span className="text-sm text-gray-800">Zanzibar Complete Escape - 8 Days</span>
                  </label>
                </div>
              )}
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-semibold text-gray-900 text-base">Zanzibar Complete Escape - 8 Days</span>
                    </div>
                    <div className="flex flex-wrap items-center gap-2 text-base text-gray-600">
                      ...
                      <span className="text-sm text-gray-600">Ultimate Zanzibar experience</span>
