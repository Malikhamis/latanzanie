...
export default function ZanzibarBeachHolidaysPage() {
  ...
  const [selectedItineraries, setSelectedItineraries] = useState<string[]>(['complete-escape', 'diving-culture', 'safari-beach-combo', 'beach-paradise'])
  const monthDropdownRef = useRef<HTMLDivElement>(null)
  const t = useTranslations('ZanzibarBeachHolidaysPage')
  ...
  // Actual Zanzibar packages available
  ...
  // Itinerary options for Zanzibar beach packages
  const itineraryOptions = zanzibarPackages.map(pkg => ({
    id: pkg.id,
    label: pkg.name
  }))
  ...
  useEffect(() => {
    ...
    const defaultItineraryId = 'classic'
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#00A896] to-[#008576] py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-lg">Trips/Zanzibar Beach Holidays</span>
              </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-3 mb-6">
            {zanzibarPackages
              .filter((pkg: typeof zanzibarPackages[0]) => selectedItineraries.length === 0 || selectedItineraries.includes(pkg.id))
              .map((pkg: typeof zanzibarPackages[0]) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3">
                  {t('topReads.whatToPack.title')}
                </h3>
                <p className="text-gray-600">
                  {t('topReads.whatToPack.subtitle')}
                </p>
                <p className="text-gray-600 mt-2">
                  {t('topReads.whatToPack.description')}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3">
                  {t('topReads.thingsToDo.title')}
                </h3>
                <p className="text-gray-600">
                  {t('topReads.thingsToDo.subtitle')}
                </p>
                <p className="text-gray-600 mt-2">
                  {t('topReads.thingsToDo.description')}
                </p>
              </div>
            </div>
          </div>
