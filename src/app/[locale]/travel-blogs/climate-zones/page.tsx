  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="md:hidden py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">{locale === 'fr' ? 'Zones' : 'Zones'}</h3>
          <nav className="space-y-2 text-sm">
            {zones.map(z => (
              <a key={z.id} href={`#${z.id}`} className="block text-gray-700 hover:text-teal-600">{z.title}</a>
            ))}
          </nav>
        </div>
      </section>
              ...
              <div className="flex-1">
                <div className="space-y-4">
                  ...
                  <div key="zone1" id="zone1-detail" className="bg-gray-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 animate-fadeIn">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 leading-snug">Zone 1 : La Zone de Base – Forêts tropicales et humides</h2>
                  ...
                  <div key="zone2" id="zone2-detail" className="bg-gray-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 animate-fadeIn">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 leading-snug">Zone 2 : La Zone Moyenne – Collines et Forêts de Bambous</h2>
                  ...
                  <div key="zone3" id="zone3-detail" className="bg-gray-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 animate-fadeIn">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 leading-snug">Zone 3 : La Zone Alpine – Herbes Hautes et Brumes Matinales</h2>
                  ...
                  <div key="zone4" id="zone4-detail" className="bg-gray-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 animate-fadeIn">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 leading-snug">Zone 4 : La Zone Subglaciaire – Rochers et Début de la Neige</h2>
                  ...
                  <div key="zone5" id="zone5-detail" className="bg-gray-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 animate-fadeIn">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 leading-snug">Zone 5 : La Zone Sommital – Neige, Glaciers et Panoramas Spectaculaires</h2>
