...
export default function ShoesPage({ params }: { params: { locale?: string } }) {
  ...
  const t = useTranslations('BlogPosts.choisir-chaussures-randonnee-kilimandjaro')
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 border-b border-gray-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <AuthorMeta author={locale === 'fr' ? 'Expert Matériel' : 'Gear Expert'} date={locale === 'fr' ? 'Décembre 2025' : 'December 2025'} />
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto md:flex md:gap-8">
            ...
            <div className="flex-1 space-y-6">
              <div className="mb-8">
                ...
                <p className="text-base md:text-lg text-gray-600 max-w-3xl">{locale === 'fr' ? 'Choisir les bonnes chaussures pour le Kilimandjaro.' : 'Choosing the right boots for Kilimanjaro.'}</p>
              </div>
