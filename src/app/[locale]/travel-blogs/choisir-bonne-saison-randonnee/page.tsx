    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="hero-wavy bg-cover bg-center text-white py-20 pt-32 md:pt-40" style={{ backgroundImage: "url('/images/climate-hero.jpg')" }}>
        <div className="container mx-auto px-4">
          <Link href={`/${locale}/travel-blogs/climb-kilimanjaro#all-topics`} className="text-[#E8F8F5] hover:text-white mb-6 inline-flex items-center text-sm font-medium animate-slideInLeft transition-colors">
            ...
            <div className="flex-1 space-y-8">
              ...
              <section id="saison2" className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="prose prose-xl max-w-none text-gray-700">
                  ...
                  <p className="mb-4"><Link href={`/${locale}/travel-blogs/zones-climatiques-kilimandjaro`} className="text-[#00A896] hover:text-[#008576] font-medium font-medium">Les températures</Link>, bien que fraîches la nuit, restent régulières et permettent une acclimatation efficace. Les panoramas sont absolument superbes, surtout au lever du soleil au sommet. Cette période attire plus de voyageurs, mais l'ambiance est conviviale, motivante et parfaitement adaptée à une ascension réussie.</p>
